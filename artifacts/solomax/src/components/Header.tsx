      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        <div className="flex items-center">
          <img
            ...
            style={{ height: 64, width: 'auto', cursor: 'pointer', filter: 'brightness(0) invert(1)' }}
        ...
        <a
          href="#lead-capture"
          className="hidden md:flex btn-primary px-5 py-2.5 rounded-full text-sm font-semibold"
        >
          Get the Book
        </a>

        <button
          className="md:hidden flex items-center justify-center w-11 h-11 rounded-full glass-light border border-white/15 text-white"
